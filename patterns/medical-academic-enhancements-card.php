...
/**
 * Title: Item Card
 * Slug: medical-academic-enhancements/card
...
return array(
	'title'       => __( 'Item Card', 'medical-academic-enhancements' ),
	'slug'        => 'medical-academic-enhancements/card',
	'categories'  => array( 'medical-academic-enhancements' ),
	'description' => __( 'A single item card for use in grids and lists.', 'medical-academic-enhancements' ),
	'content'     => '<!-- wp:group {"className":"medical-academic-enhancements-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group medical-academic-enhancements-card">
	...
	<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">
		...
		<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"medical-academic-enhancements/field","args":{"key":"subheading"}}}},"style":{"typography":{"fontStyle":"italic"},"color":{"text":"#666666"}}} -->
