...
return array(
	 ...
	 */
	'title'         => __( 'Example Card', 'medical-academic-enhancements' ),
	 ...
	 */
	'description'   => __( 'A card layout for displaying content in grids and queries. Includes image, title, excerpt, and metadata.', 'medical-academic-enhancements' ),
	 ...
	 */
	'keywords'      => array(
		__( 'card', 'medical-academic-enhancements' ),
		__( 'grid', 'medical-academic-enhancements' ),
		__( 'post', 'medical-academic-enhancements' ),
		__( 'layout', 'medical-academic-enhancements' ),
	),
	 ...
	 *
	 * Examples: array( 'medical-academic-enhancements', 'post', 'page' )
	 */
	'postTypes'     => array( 'medical-academic-enhancements' ),
	 ...
	 */
	'content'       => '<!-- wp:group {"metadata":{"name":"' . esc_attr__( 'Example Card', 'medical-academic-enhancements' ) . '","categories":["example-plugin"],"patternName":"example_plugin/example-card"},"className":"example-plugin-card overflow-hidden is-style-shadow-sm","style":{"spacing":{"blockGap":"var(--wp--preset--spacing--20, 1rem)"},"border":{"radius":"0.5rem"}},"layout":{"type":"default"},"ariaLabel":"' . esc_attr__( 'Example Card', 'medical-academic-enhancements' ) . '"} -->
<div aria-label="' . esc_attr__( 'Example Card', 'medical-academic-enhancements' ) . '" class="wp-block-group example-plugin-card overflow-hidden is-style-shadow-sm" style="border-radius:0.5rem">

	<!-- wp:post-featured-image {"isLink":true,"aspectRatio":"3/2","linkTarget":"_blank"} /-->

	<!-- wp:group {"metadata":{"name":"' . esc_attr__( 'Card Content', 'medical-academic-enhancements' ) . '"},"style":{"spacing":{"padding":{"top":"var(--wp--preset--spacing--30, 1.5rem)","bottom":"var(--wp--preset--spacing--30, 1.5rem)","left":"var(--wp--preset--spacing--30, 1.5rem)","right":"var(--wp--preset--spacing--30, 1.5rem)"},"blockGap":"var(--wp--preset--spacing--20, 1rem)"}},"layout":{"type":"default"}} -->
	<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--30, 1.5rem);padding-right:var(--wp--preset--spacing--30, 1.5rem);padding-bottom:var(--wp--preset--spacing--30, 1.5rem);padding-left:var(--wp--preset--spacing--30, 1.5rem)">
		...
		<!-- wp:group {"metadata":{"name":"' . esc_attr__( 'Card Meta', 'medical-academic-enhancements' ) . '"},"className":"example-plugin-card__meta","style":{"spacing":{"blockGap":"var(--wp--preset--spacing--10, 0.5rem)","margin":{"top":"var(--wp--preset--spacing--20, 1rem)"}}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"},"fontSize":"small"} -->
