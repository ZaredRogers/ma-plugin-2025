...
class Fields {
	...
	public function register_fields() {
		...
		acf_add_local_field_group(
			array(
				'key'      => 'group_advertiser',
				'title'    => __( 'Advertiser Details', 'medical-academic-enhancements' ),
				'fields'   => array(
					array(
					...
					array(
						...
						'label' => __( 'Contact Name', 'medical-academic-enhancements' ),
						'name'  => 'contact_name',
						'type'  => 'text',
					),
					array(
						'key'   => 'field_contact_email',
						'label' => __( 'Contact Email', 'medical-academic-enhancements' ),
						'name'  => 'contact_email',
						'type'  => 'email',
					),
					array(
						'key'   => 'field_contact_phone',
						'label' => __( 'Contact Phone', 'medical-academic-enhancements' ),
						'name'  => 'contact_phone',
						'type'  => 'text',
					),
					array(
						'key'   => 'field_industry',
						'label' => __( 'Industry', 'medical-academic-enhancements' ),
						'name'  => 'industry',
						'type'  => 'text',
					),
					array(
						'key'   => 'field_reporting_notes',
						'label' => __( 'Reporting Notes', 'medical-academic-enhancements' ),
