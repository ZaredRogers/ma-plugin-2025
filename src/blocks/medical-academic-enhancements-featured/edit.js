...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title={__('Settings', 'medical-academic-enhancements')}>
					<RangeControl
					...
					<SelectControl
						...
						options={[
							...
							{
								label: __('Featured First', 'medical-academic-enhancements'),
								value: 'featured-first',
							},
							{
								label: __('Hero', 'medical-academic-enhancements'),
								value: 'hero',
							},
						]}
				...
				<PanelBody title={__('Display Settings', 'medical-academic-enhancements')}>
					...
					/>
					<ToggleControl
						label={__('Display Subtitle', 'medical-academic-enhancements')}
					...
					/>
					<ToggleControl
						label={__('Display Read More', 'medical-academic-enhancements')}
					...
					{displayReadMore && (
						<TextControl
							label={__('Read More Text', 'medical-academic-enhancements')}
							value={readMoreText}
							onChange={(value) =>
			...
			<div {...blockProps}>
				{posts === null && (
					<p className="wp-block-example_plugin-example-plugin-featured__loading">
						{__('Loading…', 'medical-academic-enhancements')}
					</p>
				)}
								...
								<div className="wp-block-example_plugin-example-plugin-featured__content">
									...
									{displaySubtitle && (
										<p className="wp-block-example_plugin-example-plugin-featured__subtitle">
											{__('Subtitle', 'medical-academic-enhancements')}
										</p>
									)}
