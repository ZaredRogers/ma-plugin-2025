...
<div <?php echo $wrapper_attributes; ?>>
	...
	<?php if ( $show_arrows && count( $slider_slides ) > $slides_to_show ) : ?>
		<button class="wp-block-example_plugin-example-plugin-slider__arrow wp-block-example_plugin-example-plugin-slider__arrow--prev" aria-label="<?php esc_attr_e( 'Previous slide', 'medical-academic-enhancements' ); ?>">
			<span aria-hidden="true">&lsaquo;</span>
		</button>
		<button class="wp-block-example_plugin-example-plugin-slider__arrow wp-block-example_plugin-example-plugin-slider__arrow--next" aria-label="<?php esc_attr_e( 'Next slide', 'medical-academic-enhancements' ); ?>">
			<span aria-hidden="true">&rsaquo;</span>
		</button>
	<?php endif; ?>

	<?php if ( $show_dots && count( $slider_slides ) > $slides_to_show ) : ?>
		<div class="wp-block-example_plugin-example-plugin-slider__dots" role="tablist" aria-label="<?php esc_attr_e( 'Slider navigation', 'medical-academic-enhancements' ); ?>">
			<?php
			...
			for ( $i = 0; $i < $total_dots; $i++ ) :
				...
				<button
					...
					aria-label="<?php printf( esc_attr__( 'Go to slide %d', 'medical-academic-enhancements' ), $i + 1 ); ?>"
