...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title={__('Slider Source', 'medical-academic-enhancements')}>
					<SelectControl
						label={__('Slide Source', 'medical-academic-enhancements')}
						value={source}
						options={[
							{
								label: __('Custom Slides', 'medical-academic-enhancements'),
								value: 'custom',
							},
							{
								label: __('Posts', 'medical-academic-enhancements'),
								value: 'posts',
							},
							{
								label: __('Repeater Field', 'medical-academic-enhancements'),
								value: 'repeater',
							},
						]}
				...
				<PanelBody title={__('Slider Settings', 'medical-academic-enhancements')}>
					<ToggleControl
						label={__('Autoplay', 'medical-academic-enhancements')}
						checked={autoplay}
						onChange={(value) => setAttributes({ autoplay: value })}
					/>
					{autoplay && (
						<RangeControl
							label={__('Autoplay Speed (ms)', 'medical-academic-enhancements')}
							value={autoplaySpeed}
							onChange={(value) =>
					...
					<ToggleControl
						label={__('Show Dots', 'medical-academic-enhancements')}
						checked={showDots}
						onChange={(value) => setAttributes({ showDots: value })}
					/>
					<ToggleControl
						label={__('Show Arrows', 'medical-academic-enhancements')}
						checked={showArrows}
						onChange={(value) =>
					...
					/>
					<ToggleControl
						label={__('Infinite Loop', 'medical-academic-enhancements')}
						checked={infinite}
						onChange={(value) => setAttributes({ infinite: value })}
					/>
					<RangeControl
						label={__('Slides to Show', 'medical-academic-enhancements')}
						value={slidesToShow}
						onChange={(value) =>
					...
					/>
					<RangeControl
						label={__('Slides to Scroll', 'medical-academic-enhancements')}
			...
			<div {...blockProps}>
				{source === 'custom' && (
					<>
						...
						>
							{__('Add Slide', 'medical-academic-enhancements')}
						</Button>
					</>
				)}
