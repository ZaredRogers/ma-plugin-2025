...
<div <?php echo $wrapper_attributes; ?>>
			...
			<nav class="wp-block-example_plugin-example-plugin-collection__pagination">
				...
				echo paginate_links(
					array(
						...
						'prev_text' => __( '&laquo; Previous', 'medical-academic-enhancements' ),
						'next_text' => __( 'Next &raquo;', 'medical-academic-enhancements' ),
					)
				);
				?>
			</nav>
	...
	<?php else : ?>
		<p class="wp-block-example_plugin-example-plugin-collection__no-results">
			<?php esc_html_e( 'No items found.', 'medical-academic-enhancements' ); ?>
		</p>
	<?php endif; ?>
</div>
